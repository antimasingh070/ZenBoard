...
# every 50.minute do
#   command "cd /Users/user/Trackmine/app && curl -o issues.pdf 'http://localhost:3000/issues.pdf?api_key=c2abc90d5f095aeef1459ae4de37d50edd1b2ed8' && rails runner 'MailerScript.send_issue_email'"
# end


# every 50.minute, at: '7:00 am' do
#   command "cd /Users/user/Trackmine && ruby download_csv.rb  && rails runner 'MailerScript.send_dashboard_email'"
# end
