...
root to: 'my#page', as: 'home'
  ...
  get 'resource_management', to: 'welcome#resource_management'
  get 'welcome/export_resource_management_to_csv', to: 'welcome#export_resource_management_to_csv'
  ...
  resources :business_requirements do
    ...
    resources :meetings do
      ...
      resources :moms do
        resources :points, only: [:create, :update, :destroy] do
          member do
            post 'accept'
            post 'reject'
          end
